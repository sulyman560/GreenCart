...
const Cart = () => {
    const { products, currency, cartItems, removeFromCart, getCartCount, updateCartItem, navigate, getCartAmount,
        user, axios, setCartItems } = useAppContext()
            ...
            <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
                ...
                <div className="mb-6">
                    ...
                    <div className="relative flex justify-between items-start mt-2">
                        <p className="text-gray-500">{setSelectedAddress ? `${setSelectedAddress.street}, ${setSelectedAddress.city}, 
                        ${setSelectedAddress.state}, ${setSelectedAddress.country}` : "No address found"}</p>
                        ...
                        {showAddress && (
                            <div className="absolute top-12 py-1 bg-white border border-gray-300 text-sm w-full">
                                ...
                                <p onClick={() => navigate("add-address")} className="text-primary-500 text-center cursor-pointer 
